            ...
            children: [
                    ...
                    Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: SansBold(LanguageText.getBubbleText(languageViewModel.language), 15),
                        ),
                        ...
                        Sans(LanguageText.getTitleText(languageViewModel.language), 30.0),
                        SizedBox(
                          height: 15.0,
                        ),
                        Row(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        SansBold(LanguageText.getAboutTitle(languageViewModel.language), 40.0),
                        SizedBox(
                          height: 15.0,
                        ),
                        Sans(
              ...
              SizedBox(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    SansBold(LanguageText.getSkillsTitle(languageViewModel.language), 40.0),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        AnimatedCard(
                            imagePath: 'assets/webL.png',
                            text: LanguageText.getSkillsText(languageViewModel.language, true)
                        ),
                        AnimatedCard(
                          imagePath: 'assets/app.png',
                          text: LanguageText.getSkillsText(languageViewModel.language, false),
                          fit: BoxFit.contain,
                          reverse: true,
                        ),
                        AnimatedCard(
